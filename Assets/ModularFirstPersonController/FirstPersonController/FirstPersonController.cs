...
public class FirstPersonController : MonoBehaviour
{
    ...
    public float fallMultiplier = 2.5f;  // Added fall multiplier for tighter jump feel
    ...
    void FixedUpdate()
    {
        ...
        // Apply additional downward force for a tighter jump when falling
    ...
    public class FirstPersonControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Added fall multiplier inspector slider
            fpc.fallMultiplier = EditorGUILayout.Slider(new GUIContent("Fall Multiplier", "Determines the extra gravity applied when falling."), fpc.fallMultiplier, 1f, 5f);
            GUI.enabled = true;
